...
<body background="../images/tamnosvetlo.svg">
            ...
            <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                ...
                <div class="flex items-center lg:order-2">
                    ...
                    ?>
                        ...
                        <a href="" class="text-secondary bg-primary hover:bg-primary-hover font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2">Одјави се</a>
                    <?php
                    } else {
                    ?>
                        ...
                        <a href="../auth/signup.html" class="text-secondary bg-primary hover:bg-primary-hover font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2">Започни</a>
                    <?php
                    }
                    ?> 
    ...
    <section>
        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
            <div class="mx-auto max-w-screen-sm text-center lg:mb-16 mb-8">
                <h2 class="mb-4 text-3xl lg:text-4xl tracking-tight font-extrabold text-white">Магазин</h2>
    ...
    <script src="display_blogs.js"></script>
</body>
</html>