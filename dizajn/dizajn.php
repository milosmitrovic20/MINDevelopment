...
<body class="bg-background">
    ...
    <section>
            <div class=" mx-auto max-w-screen-md text-center mb-8 px-4 sm:px-0">
                ...
                <h3 class="mb-4 font-light text-gray-500 sm:text-xl dark:text-gray-400">We use an agile approach to test assumptions and connect with the needs of your audience early and often.</h3>
