...
<body class="bg-background">
            ...
            <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                ...
                <div class="hidden justify-between items-center w-full lg:flex lg:w-auto lg:order-1" id="mobile-menu-2">
                    <ul class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                        ...
                        <li>
                            <a href="./magazin.php" class="block py-2 pr-4 pl-3 text-accent transition duration-300 transform hover:scale-110 lg:border-0 lg:p-0" aria-current="page">Магазин</a>
                        </li>
                        <li>
                            <a href="#" class="block py-2 pr-4 pl-3 transition duration-300 transform hover:scale-110 text-text lg:p-0">Заједница</a>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <section>
        <div class="py-8 px-4 mx-auto bg-background lg:py-16 lg:px-6">
            <div class="mx-auto max-w-screen-md sm:text-center">
                <h2 class="mb-4 text-3xl font-extrabold tracking-tight text-gray-900 sm:text-4xl dark:text-white">Претплати се за новости</h2>
                <p class="mx-auto mb-8 max-w-2xl  text-gray-500 md:mb-12 sm:text-xl dark:text-gray-400">Буди у току са развићем сајта, новим објавама и информацијама путем е-поште.</p>
                <div class="items-center mx-auto mb-3 space-y-4 max-w-screen-sm sm:flex sm:space-y-0">
                    <div class="relative w-full">
                        <label for="email" class="hidden mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Мејл адреса</label>
                        <div class="flex absolute inset-y-0 left-0 items-center pl-3 pointer-events-none">
                            <svg class="w-4 h-4 text-gray-500 dark:text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="#13a4e7" viewBox="0 0 20 16">
                                <path d="m10.036 8.278 9.258-7.79A1.979 1.979 0 0 0 18 0H2A1.987 1.987 0 0 0 .641.541l9.395 7.737Z"/>
                                <path d="M11.241 9.817c-.36.275-.801.425-1.255.427-.428 0-.845-.138-1.187-.395L0 2.6V14a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V2.5l-8.759 7.317Z"/>
                            </svg>
                        </div>
                        <input class="block p-3 pl-9 w-full text-sm text-gray-900 bg-white rounded-lg border border-gray-300 sm:rounded-none sm:rounded-l-lg focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Унеси свој мејл" type="email" id="email" required="">
                    </div>
                    <div>
                        <button type="button" id="subscribeButton" class="bg-primary py-3 px-5 w-full text-sm font-medium text-center text-text rounded-lg cursor-pointer sm:rounded-none sm:rounded-r-lg">Претплати</button>
                    </div>
                </div>           
            </div>
        </div>
        ...
        <div class="grid grid-cols-2 gap-8 px-4 py-6 lg:py-8 md:grid-cols-4">
            <div>
                ...
                <ul class="text-text font-medium">
                    ...
                    <li class="mb-4">
                        <a href="./magazin.php" class="hover:underline">Магазин</a>
                    </li>
                </ul>
            </div>
            <div>
